...
//   const {cartData,setCartData,handleCart} = useContext(CartContext);
  ...
  const singleProductData = () => {
       setIsLoading(true);
       axios.get(`https://shy-plum-greyhound-cape.cyclic.app/products/${id}`).then((res) => {
     ...
     <Image p='20px' src='https://img.gkbcdn.com/s3/bn/2301/1500x125-63c756662b40c94fdcbe6131.jpg' alt='img'></Image>
       ...
       <HStack columns={{base:1,sm:1,md:2,lg:2}} p='20px'>
         ...
         <Box align='left'  bg='white' p='10px'  w='60%' h='450px'>
              ...
              <br />
              <HStack mt='12px'>
                <HStack><Text>19 Reviews</Text> </HStack>
              
              <Text  fontSize='sm' >Brand: {singleData.brand}</Text>
             ...
             <hr />
              ...
              <HStack>
               ...
               <HStack gap='10px'>
                 <HStack><Text>Price Match</Text></HStack>
                 <HStack><Text>Dropshipping Download</Text></HStack>
                  <HStack><Text>Bulk Order Rebate</Text></HStack>
               </HStack>
